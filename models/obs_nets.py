    ...
    def forward(self, rnn_init_state=None, return_state=False, **inputs):
        ...
        for obs_group in self.input_obs_group_shapes:
            for k in self.input_obs_group_shapes[obs_group]:
                ...
                """print("k:", k, "obs_group:", obs_group, "inputs[obs_group][k]:", inputs[obs_group][k])
                print("Length of input_obs_group_shapes[obs_group][k]:", len(self.input_obs_group_shapes[obs_group][k]))
                print("ndim of inputs[obs_group][k]:", inputs[obs_group][k].shape)
                print("VALUE ERROR TRACE")"""
